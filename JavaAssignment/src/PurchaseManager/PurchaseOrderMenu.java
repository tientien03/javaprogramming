    ...
    public PurchaseOrderMenu() {
        ...
        jButtonGenerate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (inputID.isEmpty()) {
                    JOptionPane.showMessageDialog(PurchaseOrderMenu.this, "Please enter a PR code.");
                    return;
                }
                ...
                if (selectedPR == null) {
                    JOptionPane.showMessageDialog(PurchaseOrderMenu.this, "❌ Requisition not found.");
                    return;
                }

                if ("Updated".equalsIgnoreCase(selectedPR.getStatus())) { 
                    JOptionPane.showMessageDialog(PurchaseOrderMenu.this, "This requisition has already been updated to a Purchase Order.");
                    return;
                }
...
//                supplierList.add(selectedSupplier);
                ...
                JOptionPane.showMessageDialog(PurchaseOrderMenu.this, message);
